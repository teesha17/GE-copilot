      ...
      <section className={user ? "main-grid" : null}>
        ...
        <Routes>
          ...
          <Route element={<ProtectedRoute offline={offline} />}>
            <Route path="/login" element={<Login changeColorMode={changeColorMode}/>} />
            <Route path="/login/auth" element={<Login changeColorMode={changeColorMode}/>} />
            <Route path="/signup" element={<Signup changeColorMode={changeColorMode}/>} />
            <Route path="/signup/pending/:id" element={<Signup changeColorMode={changeColorMode}/>} />
